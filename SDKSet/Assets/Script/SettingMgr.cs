...
public class SettingMgr : MonoBehaviour {
    ...
    public int GetPlayingLv()
    {
        ...
        {
            _playingIndex = MTRandom.GetRandomInt(1, 600);
        ...
        else
        {
            ...
            return LvRank.GetLv(_playingIndex); 
        }
    }
   ...
   public void SaveTrack()
    ...
    void OnDraw3Toggle(bool b)
    {
        ...
        if (LevelMgr.current != null && LevelMgr.current._gameState != null)
        {
            LevelMgr.current._gameState.draw3 = b;
            LevelMgr.current.flipNum = num;
        }
    }
