...
public class ChallengeMgr : MonoBehaviour {
    ...
    void Awake()
    {
        ...
        for (int i = 0; i < 42; i++)
        {
            ...
            rTrans.localPosition = new Vector3(Sun.localPosition.x + 156 * k, 100- i / 7 * 105, 0);
            k++;
    ...
    public void NextMonth()
    {
        ...
        {
			ShowWrongDate("Future challenges not available now.");
    ...
    public CommonConfirm WrongCanvas;
    //public Text wrongDesc;
    public void ShowWrongDate(string str)
    {
        WrongCanvas.SetContent (str);
